...
import tkinter as tk  # Para acceder al estilo base
...
def crear_frame_proveedores(master):  # 'master' es el frame del Dashboard
     ...
     def cargar_proveedores():
         try:
             ...
             for i, row in enumerate(data):
                 clean_row = tuple(str(col) if not isinstance(col, (int, float, str)) else col for col in row)
                 tag = 'evenrow' if i % 2 == 0 else 'oddrow'
                 tree_proveedores.insert("", "end", values=clean_row, tags=(tag,))
     ...
     frame_tipo.pack(pady=10, anchor="center")
     ...
     entry_cuenta.pack(pady=10, fill="x")
     ...
     # Agrega líneas tipo hoja de Excel
     ...
     tree_proveedores.heading("ID", text="ID", anchor="center")
     tree_proveedores.heading("Nombre", text="Nombre", anchor="center")
     tree_proveedores.heading("Identificación", text="Identificación", anchor="center")
     tree_proveedores.heading("Tipo", text="Tipo", anchor="center")
     tree_proveedores.heading("Cuenta Bancaria", text="Cuenta Bancaria", anchor="center")
     ...
     tree_proveedores.tag_configure('evenrow', background="#d3d3d3")
     tree_proveedores.tag_configure('oddrow', background="#ffffff")
